...
Max = max([length(a1t)-1,length(a2t)-1,length(b1)-1,length(b2)-1,length(b3)-1,length(b4)-1,length(c1)-1,length(c2)-1]);
a1t = [a1t zeros(1,Max-(length(a1t)-1))];
a2t = [a2t zeros(1,Max-(length(a2t)-1))];
b1 = [b1 zeros(1,Max-(length(b1)-1))];
b2 = [b2 zeros(1,Max-(length(b2)-1))];
b3 = [b3 zeros(1,Max-(length(b3)-1))];
b4 = [b4 zeros(1,Max-(length(b4)-1))];
